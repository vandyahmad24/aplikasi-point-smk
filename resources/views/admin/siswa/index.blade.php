   ...
   <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                 <a  class="btn btn-primary" href="{{route('tambah-siswa')}}">Tambah Siswa</a>
                                    ...
                                    <table class="table table-hover" id="dataTable">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><a type="button" class="btn btn-warning" href="{{route('edit-siswa',$key->id_user)}}">
                                                  Edit
                                                </button>
                                                <a href="{{route('delete-siswa',$key->id_user)}}" class="btn btn-danger"  onclick="return confirm('Anda Yakin Akan Menghapus Tersebut?')">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
